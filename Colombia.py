...
for tradetype, url in urls.items():
    ...
    # Ensure the selected year does not exceed the Last_updated_year
    #selected_year = cli_args.year if cli_args.year and cli_args.year <= Last_updated_year else Last_updated_year
